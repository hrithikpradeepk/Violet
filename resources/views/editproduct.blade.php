                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_text text-center">
                            <div class="login_part_text_iner">
                                <h2>Edit  Product</h2>
                                <p>Edit the already existing Product!</p><br>
                                <p></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <h3>Welcome Back Admin! <br>
                                    Edit Product,  </h3>
                                <form class="row contact_form" action="/editproduct1/{{$dataproduct->id}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                {{csrf_field()}}
                                ...
                                <div class="col-md-12 " style='max-width:40%'>
                                        ...
                                        <div class="col-md-12 ">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Product Name" value="{{$dataproduct->Productname }}">
                                        <input type="text" class="form-control" id="desc" name="desc" value="{{$dataproduct->Description }}">
                                        <table> 
                                        ...
                                        <tr>
                                            ...
                                            <option selected>{{$dataproduct->brand->Brandname }}
                                            ...
                                            @endforeach 
                                                ...
                                                <tr>
                                            <td>  <input type="text" class="form-control" id="name" name="price" value="{{$dataproduct->price }}"  placeholder="Enter Price"></td>
                                                </tr>
                                                <tr>
