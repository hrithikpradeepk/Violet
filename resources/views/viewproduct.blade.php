        ...
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h1 class="text-center">Product Details</b></h1>
                    </div>
         ...
         <tr>
            <td> <h5 class="resume-title">{{$product->id }}</h5></td>
            <td> <h5 class="resume-title">{{$product->Productname }}</h5></td>
            <td> <h5 class="resume-title">{{$product->price }}</h5></td>
            <td> <h5 class="resume-title">{{$product->category->Categoryname }}</h5></td>
            <td> <h5 class="resume-title">{{$product->brand->Brandname }}</h5></td>
            <td> <h5 class="resume-title"><img width="150" height="100" class="avatar" src="{{ URL::asset('assets/images/'.$product->Productimage) }}"></h5></td>

            <td>
            <a  href={{"/editproduct/".$product->id}}><i class="material-icons">&#xE254;</i></a>
            <a onclick="return confirm('Are you sure?')" href={{"/deleteproduct/".$product->id}}><i class="material-icons">&#xE872;</i></a></td>
        </tr>
          @endforeach 
          </tbody>
            </table>
