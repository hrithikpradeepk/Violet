        ...
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h1 class="text-center">Customer Details</b></h1>
                    </div>
            ...
            <table class="table table-bordered" id="example">
                ...
                @foreach($datacust as $customer)
                            ...
                            <tr>
                            <td> <h5 class="resume-title">{{$customer->id }}</h5></td>
                            <td> <h5 class="resume-title">{{$customer->Name }}</h5></td>
                            <td><h5 class="resume-title">{{$customer->Email }}</h5></td>
                            <td> <h5 class="resume-title">{{$customer->State }}</h></td>
                            <td><h5 class="resume-title">{{$customer->Phonenum }}</h5></td>
                            <td>
