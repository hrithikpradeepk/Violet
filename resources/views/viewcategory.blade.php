        ...
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <h1 class="text-center">Category Details</b></h1>
                    </div>
         ...
         <tr>
         <td> <h5 class="resume-title">{{$category->id }}</h5></td>
         <td> <h5 class="resume-title">{{$category->Categoryname }}</h5></td>
         <td> <h5 class="resume-title"><img  height="100" class="avatar" src="{{ URL::asset('assets/images/'.$category->Catimage) }}"></h5></td>
         <td>
         <a  href={{"/editcategory/".$category->id}}><i class="material-icons">&#xE254;</i></a>
         <a onclick="return confirm('Are you sure?')" href={{"/deletecategory/".$category->id}}><i class="material-icons">&#xE872;</i></a></td>
         </tr>
          @endforeach 
