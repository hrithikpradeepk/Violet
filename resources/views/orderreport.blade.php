...
<div class="container-xl">
    <div class="table-responsive">
        <div class="table-wrapper">			
            <div class="table-title">
                <div class="row">
                  ...
                  <button  style="background-color:black;  padding: 20px 22px;"class="btn btn.info">View</button>
                        ...
                        <h1 class="text-center">Order Details</b></h1>
                    </div>
         ...
         <tr>
         <td> <h5 class="resume-title">{{$data->id }}</h5></td>
         <td> <h5 class="resume-title">{{$data->product->Productname }}</h5></td>
         <td> <h5 class="resume-title">{{$data->Orderqty }}</h5></td>
         <td> <h5 class="resume-title">{{$data->total }}</h5></td>
         <td> <h5 class="resume-title">{{$data->customer->Name }}</h5></td>
